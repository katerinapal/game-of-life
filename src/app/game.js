import { defaultgame_obj as defaultGame } from ".\\constants\\default-game.js";
...
Game.prototype.conditions = {
     ...
     * @default 2
     */
    minNeighborsToLive: constantsconfigjs_MIN_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    maxNeighborsToLive: constantsconfigjs_MAX_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    neighborsToBeBorn: constantsconfigjs_NEIGHBORS_TO_BE_BORN
};
...
function _render(cell) {
    var x = cell.x * (constantsconfigjs_CELL_WIDTH + constantsconfigjs_BORDER_WIDTH) + constantsconfigjs_BORDER_WIDTH,
        y = cell.y * (constantsconfigjs_CELL_HEIGHT + constantsconfigjs_BORDER_WIDTH) + constantsconfigjs_BORDER_WIDTH;
    cell.calculateColor();
    this.ui.canvasContext.fillStyle = cell.color;
    this.ui.canvasContext.fillRect(x, y, constantsconfigjs_CELL_WIDTH, constantsconfigjs_CELL_HEIGHT);
}
