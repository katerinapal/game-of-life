import { constantsdefaultgamejs as defaultGame } from ".\\constants\\default-game.js";
...
Game.prototype.conditions = {
     ...
     * @default 2
     */
    minNeighborsToLive: config_MIN_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    maxNeighborsToLive: config_MAX_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    neighborsToBeBorn: config_NEIGHBORS_TO_BE_BORN
};
...
function _render(cell) {
    var x = cell.x * (config_CELL_WIDTH + config_BORDER_WIDTH) + config_BORDER_WIDTH,
        y = cell.y * (config_CELL_HEIGHT + config_BORDER_WIDTH) + config_BORDER_WIDTH;
    cell.calculateColor();
    this.ui.canvasContext.fillStyle = cell.color;
    this.ui.canvasContext.fillRect(x, y, config_CELL_WIDTH, config_CELL_HEIGHT);
}

var mod_Game = Game;
export { mod_Game as Game };
