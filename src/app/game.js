import { mod_defaultgame as defaultGame } from ".\\constants\\default-game.js";
...
Game.prototype.conditions = {
     ...
     * @default 2
     */
    minNeighborsToLive: MIN_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    maxNeighborsToLive: MAX_NEIGHBORS_TO_LIVE,
     ...
     * @default 3
     */
    neighborsToBeBorn: NEIGHBORS_TO_BE_BORN
};
...
function _render(cell) {
    var x = cell.x * (CELL_WIDTH + BORDER_WIDTH) + BORDER_WIDTH,
        y = cell.y * (CELL_HEIGHT + BORDER_WIDTH) + BORDER_WIDTH;
    cell.calculateColor();
    this.ui.canvasContext.fillStyle = cell.color;
    this.ui.canvasContext.fillRect(x, y, CELL_WIDTH, CELL_HEIGHT);
}
