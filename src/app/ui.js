import {
    ...
    CELL_HEIGHT,
    BORDER_WIDTH,
    MIN_NEIGHBORS_TO_LIVE,
    MAX_NEIGHBORS_TO_LIVE,
    NEIGHBORS_TO_BE_BORN,
    keys,
...
function _toggleCellListener(event) {
    var fullCellWidth = CELL_WIDTH + BORDER_WIDTH,
        fullCellHeight = CELL_HEIGHT + BORDER_WIDTH,
        x = Math.floor((event.layerX - BORDER_WIDTH) / fullCellWidth),
        y = Math.floor((event.layerY - BORDER_WIDTH) / fullCellHeight);
...
function _createUniverse() {
    var fullCellWidth = CELL_WIDTH + BORDER_WIDTH,
        fullCellHeight = CELL_HEIGHT + BORDER_WIDTH,
        width = UNIVERSE_WIDTH * fullCellWidth + BORDER_WIDTH,
        height = UNIVERSE_HEIGHT * fullCellHeight + BORDER_WIDTH,
        template = '' +
            '<table class="wrap">' +
            '  <tr>' +
            '    <td id="zero"></td>' +
...
function _createInputPanel() {
    ...
    minToLiveElement.value = MIN_NEIGHBORS_TO_LIVE;
    maxToLiveElement.value = MAX_NEIGHBORS_TO_LIVE;
    toBeBornElement.value = NEIGHBORS_TO_BE_BORN;
