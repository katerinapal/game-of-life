import {
    ...
    CELL_WIDTH as config_CELL_WIDTH,
    CELL_HEIGHT as config_CELL_HEIGHT,
    BORDER_WIDTH as config_BORDER_WIDTH,
    MIN_NEIGHBORS_TO_LIVE as config_MIN_NEIGHBORS_TO_LIVE,
    MAX_NEIGHBORS_TO_LIVE as config_MAX_NEIGHBORS_TO_LIVE,
    NEIGHBORS_TO_BE_BORN as config_NEIGHBORS_TO_BE_BORN,
    keys as config_keys,
...
function _toggleCellListener(event) {
    var fullCellWidth = config_CELL_WIDTH + config_BORDER_WIDTH,
        fullCellHeight = config_CELL_HEIGHT + config_BORDER_WIDTH,
        x = Math.floor((event.layerX - config_BORDER_WIDTH) / fullCellWidth),
        y = Math.floor((event.layerY - config_BORDER_WIDTH) / fullCellHeight);
...
function _createUniverse() {
    var fullCellWidth = config_CELL_WIDTH + config_BORDER_WIDTH,
        fullCellHeight = config_CELL_HEIGHT + config_BORDER_WIDTH,
        width = config_UNIVERSE_WIDTH * fullCellWidth + config_BORDER_WIDTH,
        height = config_UNIVERSE_HEIGHT * fullCellHeight + config_BORDER_WIDTH,
        template = '' +
            '<table class="wrap">' +
            '  <tr>' +
            '    <td id="zero"></td>' +
...
function _createInputPanel() {
    ...
    minToLiveElement.value = config_MIN_NEIGHBORS_TO_LIVE;
    maxToLiveElement.value = config_MAX_NEIGHBORS_TO_LIVE;
    toBeBornElement.value = config_NEIGHBORS_TO_BE_BORN;
