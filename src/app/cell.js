...
function calculateColor() {
    ...
    this.color = this.isAlive ? constantsconfigjs_ALIVE_COLOR : constantsconfigjs_DEAD_COLOR;
}
...
function _detectNeighborsCoordinates() {
    var x = this.x,
        ...
        MIN_X = 0,
        MIN_Y = 0,
        MAX_X = constantsconfigjs_UNIVERSE_WIDTH - 1,
        MAX_Y = constantsconfigjs_UNIVERSE_HEIGHT - 1,
        data = [];
...
var exported_Cell = Cell;
export { exported_Cell as Cell };
