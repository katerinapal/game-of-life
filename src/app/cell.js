import {
    ...
    ALIVE_COLOR as config_ALIVE_COLOR,
    DEAD_COLOR as config_DEAD_COLOR,
...
function calculateColor() {
    ...
    this.color = this.isAlive ? config_ALIVE_COLOR : config_DEAD_COLOR;
}
...
function _detectNeighborsCoordinates() {
    var x = this.x,
        ...
        MIN_X = 0,
        MIN_Y = 0,
        MAX_X = config_UNIVERSE_WIDTH - 1,
        MAX_Y = config_UNIVERSE_HEIGHT - 1,
        data = [];
