import { UNIVERSE_WIDTH, UNIVERSE_HEIGHT, ALIVE_COLOR, DEAD_COLOR } from ".\\constants\\config.js";
'use strict';
...
function calculateColor() {
    ...
    this.color = this.isAlive ? ALIVE_COLOR : DEAD_COLOR;
}
...
function _detectNeighborsCoordinates() {
    var x = this.x,
        ...
        MIN_X = 0,
        MIN_Y = 0,
        MAX_X = UNIVERSE_WIDTH - 1,
        MAX_Y = UNIVERSE_HEIGHT - 1,
        data = [];
