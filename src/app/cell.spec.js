import { ALIVE_COLOR as config_ALIVE_COLOR, DEAD_COLOR as config_DEAD_COLOR } from ".\\constants\\config.js";
...
describe('Cell', function () {
  ...
  describe('.calculateColor method', function () {
    it('calculates color of cell', function () {
      cell.revive();
      expect(cell.color).toBe(config_ALIVE_COLOR);
      cell.kill();
      expect(cell.color).toBe(config_DEAD_COLOR);
    });
  });
